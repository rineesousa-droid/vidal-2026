        ...
        <div className="grid items-center gap-14 lg:grid-cols-[1.15fr_.85fr]">
          <div className="reveal">
            ...
            <p className="mt-6 max-w-xl text-lg leading-relaxed text-white/70">
              Envie a pauta do seu bairro, da sua entidade ou do seu município. Toda demanda recebida
              é organizada por tema e território e entra na agenda de trabalho da campanha.
            </p>
          ...
          >
            ...
            <p className="eyebrow mt-6 text-white/60">Nas urnas em 2026</p>
